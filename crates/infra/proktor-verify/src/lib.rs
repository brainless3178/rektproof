//! # Proktor Verify — Full Program Verification
//!
...
impl VerificationEngine {
    ...
    fn generate_badge(program_name: &str, tier: &VerificationTier, score: u8) -> String {
        ...
        svg.push_str(&format!("<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"280\" height=\"28\" role=\"img\" aria-label=\"Proktor: {}\">", label));
        svg.push_str(&format!("<title>Proktor Verification: {} - {}</title>", program_name, label));
        ...
        svg.push_str("<text x=\"50\" y=\"19\" fill=\"#fff\">proktor</text>");
