...
//!
//! Generates an OpenAPI 3.0 JSON specification for the Proktor Security Oracle API.
...
pub async fn openapi_spec() -> HttpResponse {
    let spec = json!({
        "openapi": "3.0.3",
        "info": {
            "title": "Proktor Security Oracle API",
            ...
            "version": "1.0.0",
            "contact": {
                "name": "Proktor Security",
                "url": "https://github.com/proktor-security"
            },
            "license": {
                "name": "MIT",
        ...
        "servers": [
            ...
            {
                "url": "https://api.proktor.security",
        ...
        "components": {
            "securitySchemes": {
                "ApiKeyAuth": {
                    ...
                    "in": "header",
                    "name": "X-API-Key",
                    "description": "API key for authenticated endpoints. Set via PROKTOR_API_KEY environment variable. If unset, all endpoints are open (dev mode)."
                }
            },
            "schemas": {
                "HealthResponse": {
...
<head>
    <meta charset="UTF-8">
    <title>Proktor API Documentation</title>
