//! # Proktor Guard — Solana Dependency Firewall
//!
...
//!
//! ```rust,no_run
//! use proktor_guard::GuardScanner;
//! use std::path::Path;
//!
...
/// Severity levels aligned with the rest of the Proktor platform.
...
/// Full scan report from `proktor guard`.
#[derive(Debug, Clone, Serialize, Deserialize)]
