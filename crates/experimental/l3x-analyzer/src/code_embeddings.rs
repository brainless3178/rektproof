...
pub struct CodeEmbedder {
    ...
    pub(crate) token_weights: HashMap<String, f32>,
}
...
impl CodeEmbedder {
    ...
    fn initialize_token_weights() -> HashMap<String, f32> {
        ...
        // Solana-specific high-risk tokens
        weights.insert("lamports".to_string(), 0.75);
        weights.insert("transfer".to_string(), 0.8);
        weights.insert("mint_to".to_string(), 0.85);
        weights.insert("burn".to_string(), 0.7);
        weights.insert("set_authority".to_string(), 0.9);
        weights.insert("create_account".to_string(), 0.6);
        weights.insert("try_borrow_mut_lamports".to_string(), 0.85);
        weights.insert("try_borrow_mut_data".to_string(), 0.7);
        weights.insert("system_instruction".to_string(), 0.65);

        // PDA & seeds (miscalculation = confusion attack)
        weights.insert("find_program_address".to_string(), 0.7);
        weights.insert("create_program_address".to_string(), 0.75);
        weights.insert("bump".to_string(), 0.5);
        weights.insert("seeds".to_string(), 0.55);

        // Rent & state management
        weights.insert("rent_exempt".to_string(), 0.4);
        weights.insert("realloc".to_string(), 0.65);
        weights.insert("zero_copy".to_string(), 0.5);
        ...
        weights.insert("checked_div".to_string(), -0.3);
        weights.insert("saturating_add".to_string(), -0.25);
        weights.insert("saturating_sub".to_string(), -0.25);
        weights.insert("saturating_mul".to_string(), -0.25);
        weights.insert("require!".to_string(), -0.4);
        weights.insert("require_keys_eq!".to_string(), -0.5);
        weights.insert("has_one".to_string(), -0.4);
        weights.insert("constraint".to_string(), -0.35);
        weights.insert("assert_eq!".to_string(), -0.3);
