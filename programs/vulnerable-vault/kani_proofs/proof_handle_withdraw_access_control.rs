//! Kani proof: Access control for `handle_withdraw`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:42
//! Invariant: Instruction 'handle_withdraw' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_handle_withdraw_access_control() {
