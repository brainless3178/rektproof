//! Kani proof: Bounds check for `UserAccount`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:207
//! Invariant: Account 'UserAccount' balance fields (balance) must be within valid range [0, u64::MAX]
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_useraccount_balance_fields_bounded() {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_useraccount_balance_fields_bounded_fee_bps() {
