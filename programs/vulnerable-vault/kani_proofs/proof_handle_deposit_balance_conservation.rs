//! Kani proof: Balance conservation for `handle_deposit`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:30
//! Invariant: Token/SOL balance changes in 'handle_deposit' must conserve total supply (no creation from nothing)
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_handle_deposit_balance_conservation() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_handle_deposit_balance_conservation_transitive() {
