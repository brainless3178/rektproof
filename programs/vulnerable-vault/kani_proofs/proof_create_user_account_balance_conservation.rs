//! Kani proof: Balance conservation for `create_user_account`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:84
//! Invariant: Token/SOL balance changes in 'create_user_account' must conserve total supply (no creation from nothing)
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_create_user_account_balance_conservation() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_create_user_account_balance_conservation_transitive() {
