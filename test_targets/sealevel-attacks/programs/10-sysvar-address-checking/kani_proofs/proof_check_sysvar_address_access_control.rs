//! Kani proof: Access control for `check_sysvar_address`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:9
//! Invariant: Instruction 'check_sysvar_address' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_check_sysvar_address_access_control() {
