//! Kani proof: Balance conservation for `log_message`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:11
//! Invariant: Token/SOL balance changes in 'log_message' must conserve total supply (no creation from nothing)
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_log_message_balance_conservation() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_log_message_balance_conservation_transitive() {
