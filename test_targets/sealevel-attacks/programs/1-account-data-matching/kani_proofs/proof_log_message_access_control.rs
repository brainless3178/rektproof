//! Kani proof: Access control for `log_message`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:11
//! Invariant: Instruction 'log_message' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_log_message_access_control() {
