//! Kani proof: Access control for `set_value`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:9
//! Invariant: Instruction 'set_value' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_set_value_access_control() {
