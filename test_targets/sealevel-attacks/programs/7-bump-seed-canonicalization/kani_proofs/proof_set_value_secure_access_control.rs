//! Kani proof: Access control for `set_value_secure`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:9
//! Invariant: Instruction 'set_value_secure' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_set_value_secure_access_control() {
