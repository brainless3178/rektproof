//! Kani proof: Balance conservation for `withdraw_tokens`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:10
//! Invariant: Token/SOL balance changes in 'withdraw_tokens' must conserve total supply (no creation from nothing)
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_withdraw_tokens_balance_conservation() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_withdraw_tokens_balance_conservation_transitive() {
