//! Kani proof: PDA validation for `proof_withdrawtokens_constraint_1`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: proof_solana_withdrawtokens.rs:46
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_proof_withdrawtokens_constraint_1_pda_validation() {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_proof_withdrawtokens_constraint_1_pda_validation_bump() {
        let bump: u8 = kani::any();
