//! Kani proof: Access control for `withdraw_tokens`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:10
//! Invariant: Instruction 'withdraw_tokens' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_withdraw_tokens_access_control() {
