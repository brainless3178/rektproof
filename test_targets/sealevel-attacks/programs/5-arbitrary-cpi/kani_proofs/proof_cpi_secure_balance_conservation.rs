//! Kani proof: Balance conservation for `cpi_secure`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:10
//! Invariant: Token/SOL balance changes in 'cpi_secure' must conserve total supply (no creation from nothing)
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_cpi_secure_balance_conservation() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_cpi_secure_balance_conservation_transitive() {
