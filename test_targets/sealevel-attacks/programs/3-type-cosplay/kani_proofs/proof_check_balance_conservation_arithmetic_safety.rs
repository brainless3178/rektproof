//! Kani proof: Arithmetic safety for `check_balance_conservation`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: invariants.rs:8
//! Invariant: All arithmetic in 'check_balance_conservation' must not overflow/underflow at u64 boundary

#[cfg(kani)]
mod kani_proofs {
    /// Verify that all arithmetic operations in `check_balance_conservation` are overflow-safe
    /// at the bit-precise u64 level.
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_check_balance_conservation_arithmetic_safety() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_check_balance_conservation_arithmetic_safety_checked() {
        let a: u64 = kani::any();
        let b: u64 = kani::any();
