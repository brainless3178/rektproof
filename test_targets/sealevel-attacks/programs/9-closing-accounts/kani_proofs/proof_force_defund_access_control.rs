//! Kani proof: Access control for `force_defund`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:33
//! Invariant: Instruction 'force_defund' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_force_defund_access_control() {
