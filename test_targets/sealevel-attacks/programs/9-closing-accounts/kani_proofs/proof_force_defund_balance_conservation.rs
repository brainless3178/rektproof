//! Kani proof: Balance conservation for `force_defund`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:33
//! Invariant: Token/SOL balance changes in 'force_defund' must conserve total supply (no creation from nothing)
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_force_defund_balance_conservation() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_force_defund_balance_conservation_transitive() {
