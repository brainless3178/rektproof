//! Kani proof: Balance conservation for `close`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:11
//! Invariant: Token/SOL balance changes in 'close' must conserve total supply (no creation from nothing)
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_close_balance_conservation() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_close_balance_conservation_transitive() {
