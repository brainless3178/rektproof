//! Kani proof: Balance conservation for `deposit_for_burn_with_caller`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:82
//! Invariant: Token/SOL balance changes in 'deposit_for_burn_with_caller' must conserve total supply (no creation from nothing)
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_deposit_for_burn_with_caller_balance_conservation() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_deposit_for_burn_with_caller_balance_conservation_transitive() {
