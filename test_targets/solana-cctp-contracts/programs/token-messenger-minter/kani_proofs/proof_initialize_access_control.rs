//! Kani proof: Access control for `initialize`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:43
//! Invariant: Instruction 'initialize' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_initialize_access_control() {
