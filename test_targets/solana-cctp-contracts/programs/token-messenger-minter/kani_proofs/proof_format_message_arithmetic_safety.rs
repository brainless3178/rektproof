//! Kani proof: Arithmetic safety for `format_message`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: burn_message.rs:method
//! Invariant: All arithmetic in 'format_message' must not overflow/underflow

#[cfg(kani)]
mod kani_proofs {
    /// Verify that all arithmetic operations in `format_message` are overflow-safe
    /// at the bit-precise u64 level.
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_format_message_arithmetic_safety() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_format_message_arithmetic_safety_checked() {
        let a: u64 = kani::any();
        let b: u64 = kani::any();
