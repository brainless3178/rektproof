//! Kani proof: Access control for `replace_deposit_for_burn`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:89
//! Invariant: Instruction 'replace_deposit_for_burn' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_replace_deposit_for_burn_access_control() {
