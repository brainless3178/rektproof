//! Kani proof: Balance conservation for `transfer_ownership`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:47
//! Invariant: Token/SOL balance changes in 'transfer_ownership' must conserve total supply (no creation from nothing)
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_transfer_ownership_balance_conservation() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_transfer_ownership_balance_conservation_transitive() {
