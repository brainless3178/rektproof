//! Kani proof: Access control for `remove_remote_token_messenger`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:68
//! Invariant: Instruction 'remove_remote_token_messenger' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_remove_remote_token_messenger_access_control() {
