//! Kani proof: Balance conservation for `replace_deposit_for_burn`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:89
//! Invariant: Token/SOL balance changes in 'replace_deposit_for_burn' must conserve total supply (no creation from nothing)
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_replace_deposit_for_burn_balance_conservation() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_replace_deposit_for_burn_balance_conservation_transitive() {
