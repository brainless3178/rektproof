//! Kani proof: Access control for `deposit_for_burn_with_caller`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:82
//! Invariant: Instruction 'deposit_for_burn_with_caller' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_deposit_for_burn_with_caller_access_control() {
