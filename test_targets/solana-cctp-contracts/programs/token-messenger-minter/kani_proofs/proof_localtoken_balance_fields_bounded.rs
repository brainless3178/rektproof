//! Kani proof: Bounds check for `LocalToken`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: state.rs:47
//! Invariant: Account 'LocalToken' balance fields (amount_sent, amount_received) must be within valid range [0, u64::MAX]
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_localtoken_balance_fields_bounded() {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_localtoken_balance_fields_bounded_fee_bps() {
