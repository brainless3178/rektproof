//! Kani proof: Access control for `disable_attester`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:100
//! Invariant: Instruction 'disable_attester' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_disable_attester_access_control() {
