//! Kani proof: Access control for `set_max_message_body_size`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:86
//! Invariant: Instruction 'set_max_message_body_size' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_set_max_message_body_size_access_control() {
