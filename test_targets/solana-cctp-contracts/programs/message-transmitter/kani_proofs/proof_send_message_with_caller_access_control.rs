//! Kani proof: Access control for `send_message_with_caller`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:121
//! Invariant: Instruction 'send_message_with_caller' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_send_message_with_caller_access_control() {
