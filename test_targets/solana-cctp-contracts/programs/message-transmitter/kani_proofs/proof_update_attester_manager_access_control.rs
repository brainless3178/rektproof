//! Kani proof: Access control for `update_attester_manager`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:71
//! Invariant: Instruction 'update_attester_manager' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_update_attester_manager_access_control() {
