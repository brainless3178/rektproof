//! Kani proof: Access control for `accept_ownership`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:57
//! Invariant: Instruction 'accept_ownership' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_accept_ownership_access_control() {
