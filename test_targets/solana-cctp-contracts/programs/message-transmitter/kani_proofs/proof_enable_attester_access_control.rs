//! Kani proof: Access control for `enable_attester`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:93
//! Invariant: Instruction 'enable_attester' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_enable_attester_access_control() {
