//! Kani proof: Arithmetic safety for `recover_attester`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: state.rs:method
//! Invariant: All arithmetic in 'recover_attester' must not overflow/underflow

#[cfg(kani)]
mod kani_proofs {
    /// Verify that all arithmetic operations in `recover_attester` are overflow-safe
    /// at the bit-precise u64 level.
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_recover_attester_arithmetic_safety() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_recover_attester_arithmetic_safety_checked() {
        let a: u64 = kani::any();
        let b: u64 = kani::any();
