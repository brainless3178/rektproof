//! Kani proof: Access control for `get_nonce_pda`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:149
//! Invariant: Instruction 'get_nonce_pda' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_get_nonce_pda_access_control() {
