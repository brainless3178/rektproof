//! Kani proof: Access control for `transfer_ownership`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:50
//! Invariant: Instruction 'transfer_ownership' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_transfer_ownership_access_control() {
