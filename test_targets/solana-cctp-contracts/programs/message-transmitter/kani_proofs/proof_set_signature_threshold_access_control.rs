//! Kani proof: Access control for `set_signature_threshold`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:107
//! Invariant: Instruction 'set_signature_threshold' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_set_signature_threshold_access_control() {
