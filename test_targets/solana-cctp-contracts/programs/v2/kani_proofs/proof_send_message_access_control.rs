//! Kani proof: Access control for `send_message`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:113
//! Invariant: Instruction 'send_message' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_send_message_access_control() {
