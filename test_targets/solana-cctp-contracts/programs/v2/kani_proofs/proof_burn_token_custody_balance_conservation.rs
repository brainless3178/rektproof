//! Kani proof: Balance conservation for `burn_token_custody`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: burn_token_custody.rs:82
//! Invariant: Token/SOL balance changes in 'burn_token_custody' must conserve total supply (no creation from nothing)
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_burn_token_custody_balance_conservation() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_burn_token_custody_balance_conservation_transitive() {
