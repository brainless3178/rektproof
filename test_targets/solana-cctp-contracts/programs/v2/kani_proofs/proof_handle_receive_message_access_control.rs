//! Kani proof: Access control for `handle_receive_message`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: handle_receive_finalized_message.rs:142
//! Invariant: Instruction 'handle_receive_message' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_handle_receive_message_access_control() {
