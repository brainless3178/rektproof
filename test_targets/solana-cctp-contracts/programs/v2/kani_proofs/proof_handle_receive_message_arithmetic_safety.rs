//! Kani proof: Arithmetic safety for `handle_receive_message`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: handle_receive_finalized_message.rs:142
//! Invariant: All arithmetic in 'handle_receive_message' must not overflow/underflow at u64 boundary

#[cfg(kani)]
mod kani_proofs {
    /// Verify that all arithmetic operations in `handle_receive_message` are overflow-safe
    /// at the bit-precise u64 level.
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_handle_receive_message_arithmetic_safety() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_handle_receive_message_arithmetic_safety_checked() {
        let a: u64 = kani::any();
        let b: u64 = kani::any();
