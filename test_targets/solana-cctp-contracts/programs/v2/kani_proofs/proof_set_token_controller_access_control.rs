//! Kani proof: Access control for `set_token_controller`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: set_token_controller.rs:54
//! Invariant: Instruction 'set_token_controller' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_set_token_controller_access_control() {
