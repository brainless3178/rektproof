//! Kani proof: Access control for `add_remote_token_messenger`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:83
//! Invariant: Instruction 'add_remote_token_messenger' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_add_remote_token_messenger_access_control() {
