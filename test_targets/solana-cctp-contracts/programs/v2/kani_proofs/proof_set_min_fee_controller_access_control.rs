//! Kani proof: Access control for `set_min_fee_controller`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:104
//! Invariant: Instruction 'set_min_fee_controller' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_set_min_fee_controller_access_control() {
