//! Kani proof: Access control for `add_local_token`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: add_local_token.rs:85
//! Invariant: Instruction 'add_local_token' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_add_local_token_access_control() {
