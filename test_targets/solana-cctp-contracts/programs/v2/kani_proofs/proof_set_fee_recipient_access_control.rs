//! Kani proof: Access control for `set_fee_recipient`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:97
//! Invariant: Instruction 'set_fee_recipient' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_set_fee_recipient_access_control() {
