//! Kani proof: Access control for `set_max_burn_amount_per_message`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: set_max_burn_amount_per_message.rs:60
//! Invariant: Instruction 'set_max_burn_amount_per_message' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_set_max_burn_amount_per_message_access_control() {
