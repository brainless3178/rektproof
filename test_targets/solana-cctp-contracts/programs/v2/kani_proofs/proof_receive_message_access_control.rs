//! Kani proof: Access control for `receive_message`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:117
//! Invariant: Instruction 'receive_message' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_receive_message_access_control() {
