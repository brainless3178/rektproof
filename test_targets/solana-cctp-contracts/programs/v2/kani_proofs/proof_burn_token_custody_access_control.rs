//! Kani proof: Access control for `burn_token_custody`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: burn_token_custody.rs:82
//! Invariant: Instruction 'burn_token_custody' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_burn_token_custody_access_control() {
