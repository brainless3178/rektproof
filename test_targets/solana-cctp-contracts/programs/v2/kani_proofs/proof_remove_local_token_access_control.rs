//! Kani proof: Access control for `remove_local_token`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: remove_local_token.rs:81
//! Invariant: Instruction 'remove_local_token' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_remove_local_token_access_control() {
