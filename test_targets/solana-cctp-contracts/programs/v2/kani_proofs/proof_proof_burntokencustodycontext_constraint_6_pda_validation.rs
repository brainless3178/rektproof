//! Kani proof: PDA validation for `proof_burntokencustodycontext_constraint_6`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: proof_solana_burntokencustodycontext.rs:120
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_proof_burntokencustodycontext_constraint_6_pda_validation() {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_proof_burntokencustodycontext_constraint_6_pda_validation_bump() {
        let bump: u8 = kani::any();
