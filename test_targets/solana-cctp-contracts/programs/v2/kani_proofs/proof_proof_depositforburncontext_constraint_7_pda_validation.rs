//! Kani proof: PDA validation for `proof_depositforburncontext_constraint_7`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: proof_solana_depositforburncontext.rs:152
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_proof_depositforburncontext_constraint_7_pda_validation() {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_proof_depositforburncontext_constraint_7_pda_validation_bump() {
        let bump: u8 = kani::any();
