//! Kani proof: Access control for `is_nonce_used`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:131
//! Invariant: Instruction 'is_nonce_used' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_is_nonce_used_access_control() {
