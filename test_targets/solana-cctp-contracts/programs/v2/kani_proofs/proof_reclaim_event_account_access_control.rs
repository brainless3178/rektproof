//! Kani proof: Access control for `reclaim_event_account`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:124
//! Invariant: Instruction 'reclaim_event_account' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_reclaim_event_account_access_control() {
