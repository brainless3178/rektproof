//! Kani proof: Access control for `undenylist_account`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:55
//! Invariant: Instruction 'undenylist_account' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_undenylist_account_access_control() {
