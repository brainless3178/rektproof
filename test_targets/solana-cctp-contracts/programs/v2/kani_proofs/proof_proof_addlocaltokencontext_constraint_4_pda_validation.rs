//! Kani proof: PDA validation for `proof_addlocaltokencontext_constraint_4`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: proof_solana_addlocaltokencontext.rs:94
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_proof_addlocaltokencontext_constraint_4_pda_validation() {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_proof_addlocaltokencontext_constraint_4_pda_validation_bump() {
        let bump: u8 = kani::any();
