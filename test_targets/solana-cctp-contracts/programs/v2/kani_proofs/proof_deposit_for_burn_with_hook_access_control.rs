//! Kani proof: Access control for `deposit_for_burn_with_hook`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:122
//! Invariant: Instruction 'deposit_for_burn_with_hook' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_deposit_for_burn_with_hook_access_control() {
