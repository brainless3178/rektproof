//! Kani proof: Balance conservation for `remove_local_token`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: remove_local_token.rs:81
//! Invariant: Token/SOL balance changes in 'remove_local_token' must conserve total supply (no creation from nothing)
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_remove_local_token_balance_conservation() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_remove_local_token_balance_conservation_transitive() {
