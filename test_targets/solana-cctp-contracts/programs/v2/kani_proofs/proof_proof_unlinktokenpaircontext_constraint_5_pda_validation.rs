//! Kani proof: PDA validation for `proof_unlinktokenpaircontext_constraint_5`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: proof_solana_unlinktokenpaircontext.rs:100
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_proof_unlinktokenpaircontext_constraint_5_pda_validation() {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_proof_unlinktokenpaircontext_constraint_5_pda_validation_bump() {
        let bump: u8 = kani::any();
