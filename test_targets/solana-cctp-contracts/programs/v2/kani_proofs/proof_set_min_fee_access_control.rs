//! Kani proof: Access control for `set_min_fee`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:111
//! Invariant: Instruction 'set_min_fee' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_set_min_fee_access_control() {
