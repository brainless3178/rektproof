//! Kani proof: PDA validation for `deposit_for_burn_helper`
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_deposit_for_burn_helper_pda_validation() {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_deposit_for_burn_helper_pda_validation_bump() {
        let bump: u8 = kani::any();
