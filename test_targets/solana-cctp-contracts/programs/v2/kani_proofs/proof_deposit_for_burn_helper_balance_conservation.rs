//! Kani proof: Balance conservation for `deposit_for_burn_helper`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: deposit_for_burn.rs:146
//! Invariant: Token/SOL balance changes in 'deposit_for_burn_helper' must conserve total supply (no creation from nothing)
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_deposit_for_burn_helper_balance_conservation() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_deposit_for_burn_helper_balance_conservation_transitive() {
