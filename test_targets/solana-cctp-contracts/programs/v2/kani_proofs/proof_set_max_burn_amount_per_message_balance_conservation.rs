//! Kani proof: Balance conservation for `set_max_burn_amount_per_message`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: set_max_burn_amount_per_message.rs:60
//! Invariant: Token/SOL balance changes in 'set_max_burn_amount_per_message' must conserve total supply (no creation from nothing)
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_set_max_burn_amount_per_message_balance_conservation() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_set_max_burn_amount_per_message_balance_conservation_transitive() {
