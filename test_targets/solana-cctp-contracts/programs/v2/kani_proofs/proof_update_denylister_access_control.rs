//! Kani proof: Access control for `update_denylister`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:62
//! Invariant: Instruction 'update_denylister' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_update_denylister_access_control() {
