//! Kani proof: Arithmetic safety for `send_message_helper`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: send_message.rs:89
//! Invariant: All arithmetic in 'send_message_helper' must not overflow/underflow at u64 boundary

#[cfg(kani)]
mod kani_proofs {
    /// Verify that all arithmetic operations in `send_message_helper` are overflow-safe
    /// at the bit-precise u64 level.
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_send_message_helper_arithmetic_safety() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_send_message_helper_arithmetic_safety_checked() {
        let a: u64 = kani::any();
        let b: u64 = kani::any();
