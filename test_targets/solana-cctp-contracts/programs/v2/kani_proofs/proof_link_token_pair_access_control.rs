//! Kani proof: Access control for `link_token_pair`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: link_token_pair.rs:73
//! Invariant: Instruction 'link_token_pair' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_link_token_pair_access_control() {
