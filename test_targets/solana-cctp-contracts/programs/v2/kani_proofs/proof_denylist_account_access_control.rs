//! Kani proof: Access control for `denylist_account`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:51
//! Invariant: Instruction 'denylist_account' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_denylist_account_access_control() {
