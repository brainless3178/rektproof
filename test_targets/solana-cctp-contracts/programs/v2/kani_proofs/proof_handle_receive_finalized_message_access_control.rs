//! Kani proof: Access control for `handle_receive_finalized_message`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:129
//! Invariant: Instruction 'handle_receive_finalized_message' must validate signer/authority before state mutation
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(4)]
    fn proof_handle_receive_finalized_message_access_control() {
