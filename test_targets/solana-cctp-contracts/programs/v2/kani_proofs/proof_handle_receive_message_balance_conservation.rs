//! Kani proof: Balance conservation for `handle_receive_message`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: handle_receive_finalized_message.rs:142
//! Invariant: Token/SOL balance changes in 'handle_receive_message' must conserve total supply (no creation from nothing)
...
mod kani_proofs {
    ...
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_handle_receive_message_balance_conservation() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_handle_receive_message_balance_conservation_transitive() {
