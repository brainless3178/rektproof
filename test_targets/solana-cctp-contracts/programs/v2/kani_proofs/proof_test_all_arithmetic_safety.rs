//! Kani proof: Arithmetic safety for `test_all`
//! Auto-generated by kani-verifier — DO NOT EDIT
//! Source: lib.rs:880
//! Invariant: All arithmetic in 'test_all' must not overflow/underflow at u64 boundary

#[cfg(kani)]
mod kani_proofs {
    /// Verify that all arithmetic operations in `test_all` are overflow-safe
    /// at the bit-precise u64 level.
    #[kani::proof]
    #[kani::unwind(16)]
    fn proof_test_all_arithmetic_safety() {
    ...
    #[kani::proof]
    #[kani::unwind(8)]
    fn proof_test_all_arithmetic_safety_checked() {
        let a: u64 = kani::any();
        let b: u64 = kani::any();
